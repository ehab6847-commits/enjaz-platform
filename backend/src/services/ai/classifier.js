...
const INTENT_KEYWORDS = [
  ...
  'ممكن احد', 'ابحث عن', 'ابحث عن شخص',
  'عندي اختبار', 'عندي واجب', 'عندي مشروع', 'عندي بحث',
  'عندي كويز', 'عندي فاينل', 'عندي تكليف', 'عندي تقرير',
  'شخص يحل', 'مطلوب شخص', 'مطلوب حل', 'يحل لاب',
  'يحل', 'يسوي', 'يكتب', 'يبرمج', 'يصمم', 'يترجم', 'يساعد',
  'مين شاطر', 'مين فاهم', 'مين يعرف', 'مين يقدر', 'مين يترجم', 'مين يصمم', 'مين يبرمج',
  'عندي', 'مين عنده', 'تكفون', 'تكفى', 'ساعدوني', 'فزعه',
  'need help', 'need someone', 'looking for', 'can someone', 'anyone can',
  'do my', 'solve my', 'help me with',
];

// ─── Academic Subject Keywords ────────────────────────────────────────────────
const ACADEMIC_KEYWORDS = [
  'واجب', 'تكليف', 'بحث', 'مشروع', 'بروجكت', 'تقرير', 'سكليف',
  'برزنتيشن', 'بوربوينت', 'عرض تقديمي', 'كويز', 'اختبار', 'فاينل',
  'ميد', 'لاب', 'برمجة', 'cv', 'سيرة ذاتية', 'ترجمة', 'تصميم',
  'رياضيات', 'تدريب تعاوني', 'تدريب ميداني', 'عذر طبي', 'تقرير طبي',
  'مشروع تخرج', 'حل مادة', 'حل ماده', 'مادة', 'ماده', 'فيزياء', 'كيمياء',
  'احصاء', 'حسبان', 'جبر', 'حاسب', 'شبكات', 'قواعد بيانات', 'ويب',
  'جافا', 'بايثون', 'قانون', 'ادارة', 'محاسبة', 'اقتصاد', 'مالية',
  'انجليزي', 'ترجمه', 'كتابة', 'مقال', 'تعبير', 'تدريب',
  'assignment', 'homework', 'project', 'report', 'lab', 'quiz',
  'exam', 'presentation', 'thesis', 'research', 'essay',
  'بحوث', 'واجبات', 'مشاريع', 'كويزات', 'تقارير', 'امتحان',
  'حسبان', 'احصاء', 'فيزياء', 'كيمياء', 'حاسب', 'محاسبة', 'ادارة',
];
